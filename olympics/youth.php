...
{
	$name = $_POST["name"];
	$sql = "SELECT c.flag, c.name, yth.gold, yth.silver, yth.bronze, yth.total FROM countries c INNER JOIN youth yth ON c.id=yth.country_id WHERE c.name LIKE '%$name%' ORDER BY yth.gold DESC, yth.silver DESC, yth.bronze DESC";
