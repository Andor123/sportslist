...
{
	$name = $_POST["name"];
	$sql = "SELECT c.flag, c.name, smr.games, smr.gold, smr.silver, smr.bronze, smr.total FROM countries c INNER JOIN summer smr ON c.id=smr.country_id WHERE c.name LIKE '%$name%' ORDER BY smr.gold DESC, smr.silver DESC, smr.bronze DESC";
...
<head>
	<meta charset="utf-8">
	<title>Summer Olympics Medal Table</title>
...
<body>
	<div class="container-fluid">
		<div class="row">
			<div class="col">
				<h1 class="display-4">Summer Olympics Medal Table</h1>
			</div>
		</div>
		<div class="row">
			<div class="col">
