...
{
	$name = $_POST["name"];
	$sql = "SELECT c.flag, c.name, wrst.gold, wrst.silver, wrst.bronze, wrst.total FROM countries c INNER JOIN wrestling wrst ON c.id=wrst.country_id WHERE c.name LIKE '%$name%' ORDER BY wrst.gold DESC, wrst.silver DESC, wrst.bronze DESC";
