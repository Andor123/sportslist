		...
		<div class="row">
			<div class="col">
				<table class="table" align="center">
					...
					<tbody>
						<?php
						$sql = "SELECT c.flag, c.name, wtr.gold, wtr.silver, wtr.bronze, wtr.total FROM countries c INNER JOIN winter wtr ON c.id=wtr.country_id ORDER BY wtr.gold DESC, wtr.silver DESC, wtr.bronze DESC";
